...
const WhyChooseUsCard: React.FC<TWhyChooseUsCard> = ({
  ...
  return (
    <div className="bg-neutral-20 px-5 py-[25px] rounded-xl border border-transparent hover:border-purple-700 transition-all duration-300 relative group">
      <div className="hidden lg:block size-[300px] rounded-full bg-neutral-20 group-hover:bg-primary-20/20 bg-opacity-30 blur-[100px] absolute top-2"></div>
