    ...
    return (
        <Container>
            <div className='font-Poppins relative mt-20'>
                {/* Linner svg */}
                <svg className='w-full absolute opacity-70' xmlns="http://www.w3.org/2000/svg" width="1728" height="340" viewBox="0 0 1728 340" fill="none">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link className='text-primary-20 font-semibold' href={"/our-works"}>Our Works</Link>
                </div>
              ...
              {projectCategories?.map((category) => (
                <button
                  ...
                  key={category}
                  className={`border border-neutral-15/30 rounded-3xl focus:outline-none px-5 py-3 text-white/90 font-medium flex items-center gap-3 z-10 ${
